...
Проект консольного приложения написан на языке программирования C++ в интегрированной среде Microsoft Visual Studio. Простой ввод-вывод. Работа с массивами и случайными числами. Рассчёт среднего арифметического значения элементов массива.
